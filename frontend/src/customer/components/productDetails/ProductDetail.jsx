// taiklwind compionent ui under ecommerce-product overvioews everything is done just you need to modify it and onchnage acc to your requirement manual css we give and create file and apply once we added tailwqind css then use there inbuikd classname with classname=" it willl work directly"
"use client";
      ...
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="flex flex-col items-center">
            <div className="overflow-hidden rounded-lg max-w-[30rem] max-h-35[rem]">
              <img
            ...
            <div className="flex space-x-5 mt-4">
              {product.images.map((item) => (
                <div className="h-20 w-20 overflow-hidden rounded-lg cursor-pointer">
                  <img
                    alt={item.alt}
                    src={item.src}
                    className="h-full w-full object-cover object-center"
          ...
          <div className="lg:col:span-1 maxt-auto max-w-2xl px-4 pb-60 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <form className="mt-10">
                ...
                >
                this is simple button that we create genrally inhtml or jsx div p,buttton burt we can use mui btns here then we will get rid from this large css
                </button> */}
                <Button
                  variant="contained"
                  color="secondary "
            ...
            <Grid container spacing={7}>
              <Grid item xs={7}>
                <div className="space-y-5">
                  {/* we are using hered ummy review array to map -<p>{item.some}</p> or <p> or</p>*/}
                  {[1, 1, 1].map((item) => (
                    <ProductReviewCard />
                  ))}
                </div>
